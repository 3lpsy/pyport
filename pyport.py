...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', '--min-port', type=int, default=1)
    parser.add_argument('-M', '--max-port', type=int, default=65535)
    parser.add_argument('-T', '--threads', type=int, default=10)
    parser.add_argument('--timeout', type=int, default=10)
    parser.add_argument('--verbose', '-v', action='count',default=0)
    parser.add_argument('--no-random', action="store_true", default=False)
    parser.add_argument('-p', '--proto', type=str, default="tcp", choices=['tcp', 'udp', 'http', 'https'])
